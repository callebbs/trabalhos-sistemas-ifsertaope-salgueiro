...
'''
Escreva um programa que lê duas notas de vários alunos e armazena estas notas em um
dicionário, onde a chave é o nome do aluno. A entrada de dados deve terminar quando for lida
uma string vazia como nome. Escreva uma função que permita retornar a média do aluno, dado
o seu nome como argumento.
'''
#--------------------------------------------------------------------------------------------------
